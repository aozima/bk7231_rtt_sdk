...
#define RT_FLASH_BEKEN_SIZE              (2 * 1024 * 1024)                      // unit: bytes, total 2Mbytes
...
#define RT_BK_BL_PART_LEN             (64 * 1024)                                // logic size: 64Kbytes

#define RT_BK_APP_NAME                "app"
#define RT_BK_APP_PART_ADDR           (RT_BK_BL_PART_ADDR + RT_BK_BL_PART_LEN)   // logic addr: 0x10000     physical addr: 0x11000
#define RT_BK_APP_PART_LEN            (1156*1024/34*32)                          // logic size: 1088Kbytes  physical size: 1156Kbytes
