...
#define BEKEN_NETWORK_WORKER_PRIORITY      (3)
#define BEKEN_DEFAULT_WORKER_PRIORITY      (5)
#define BEKEN_DEFAULT_LIBRARY_PRIORITY     (5)
...
/** @defgroup BEKEN_RTOS_Thread MICO RTOS Thread Management Functions
...
/** @defgroup BEKEN_RTOS_SEM MICO RTOS Semaphore Functions
...
/** @defgroup BEKEN_RTOS_MUTEX MICO RTOS Mutex Functions
...
/** @defgroup BEKEN_RTOS_QUEUE MICO RTOS FIFO Queue Functions
...
/** @defgroup BEKEN_RTOS_EVENT MICO RTOS Event Functions
  * @{
  */
