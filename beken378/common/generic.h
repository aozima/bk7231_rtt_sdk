...
#if (ASSERT_HALT == CFG_ASSERT_OPTION)
#define assert_process() while(1)
#elif (ASSERT_REBOOT == CFG_ASSERT_OPTION)
#define assert_process() bk_reboot(); while(1)
#else
