...
//  <e> CFG_PRF_FFB3
//  <i> FFB3 AIS profile Locator Role
//  </e>
#if ( 0 )
#define CFG_PRF_FFB3
#endif
...
#endif // defined(CFG_PRF_FFE0)


///FEB3  AIS Profile Locator role
#if defined(CFG_PRF_FFB3)
#define BLE_FEB3_SERVER        1
#else
...
///SN Profile Locator role
#if defined(CFG_PRF_SN)
#define BLE_SN_SERVER        1
#else
...
/// BLE_CLIENT_PRF indicates if at least one client profile is present
        ...
        || BLE_PAS_CLIENT || BLE_IPS_CLIENT || BLE_ENV_CLIENT || BLE_WSC_CLIENT || BLE_SDP_CLIENT)
