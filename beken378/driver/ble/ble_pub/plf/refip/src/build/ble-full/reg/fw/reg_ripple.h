...
#define RPL_RPLL_VCOMMON_ON_BIT        ((uint32_t)0x00000004)
#define RPL_RPLL_VCOMMON_ON_POS        2
...
#define RPL_RPLL_VCOMMON_ON_RST        0x0
...
__INLINE uint8_t rpl_rpll_vcommon_on_getf(void)
{
    uint32_t localVal = REG_RPL_RD(RPL_RPLLCNTL0_ADDR);
    return ((localVal & ((uint32_t)0x00000004)) >> 2);
}

__INLINE void rpl_rpll_vcommon_on_setf(uint8_t rpllvcoon)
{
    ASSERT_ERR((((uint32_t)rpllvcoon << 2) & ~((uint32_t)0x00000004)) == 0);
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  25:24   RPLL_IVCOMMON_BUF_TRIM   0x0
...
// field definitions
#define RPL_RPLL_IVCOMMON_BUF_TRIM_MASK     ((uint32_t)0x03000000)
#define RPL_RPLL_IVCOMMON_BUF_TRIM_LSB      24
#define RPL_RPLL_IVCOMMON_BUF_TRIM_WIDTH    ((uint32_t)0x00000002)
...
#define RPL_RPLL_IVCOMMON_MASK              ((uint32_t)0x0000000C)
#define RPL_RPLL_IVCOMMON_LSB               2
#define RPL_RPLL_IVCOMMON_WIDTH             ((uint32_t)0x00000002)
#define RPL_RPLL_VCOMMON_MODE_MASK          ((uint32_t)0x00000003)
#define RPL_RPLL_VCOMMON_MODE_LSB           0
#define RPL_RPLL_VCOMMON_MODE_WIDTH         ((uint32_t)0x00000002)

#define RPL_RPLL_IVCOMMON_BUF_TRIM_RST      0x0
...
#define RPL_RPLL_IVCOMMON_RST               0x3
#define RPL_RPLL_VCOMMON_MODE_RST           0x0
...
__INLINE uint8_t rpl_rpll_ivcommon_buf_trim_getf(void)
{
    uint32_t localVal = REG_RPL_RD(RPL_RPLLCNTL1_ADDR);
    return ((localVal & ((uint32_t)0x03000000)) >> 24);
}

__INLINE void rpl_rpll_ivcommon_buf_trim_setf(uint8_t rpllivcobuftrim)
{
    ASSERT_ERR((((uint32_t)rpllivcobuftrim << 24) & ~((uint32_t)0x03000000)) == 0);
...
__INLINE uint8_t rpl_rpll_ivcommon_getf(void)
{
    uint32_t localVal = REG_RPL_RD(RPL_RPLLCNTL1_ADDR);
    return ((localVal & ((uint32_t)0x0000000C)) >> 2);
}

__INLINE void rpl_rpll_ivcommon_setf(uint8_t rpllivco)
{
    ASSERT_ERR((((uint32_t)rpllivco << 2) & ~((uint32_t)0x0000000C)) == 0);
    REG_RPL_WR(RPL_RPLLCNTL1_ADDR, (REG_RPL_RD(RPL_RPLLCNTL1_ADDR) & ~((uint32_t)0x0000000C)) | ((uint32_t)rpllivco << 2));
}

__INLINE uint8_t rpl_rpll_vcommon_mode_getf(void)
{
    uint32_t localVal = REG_RPL_RD(RPL_RPLLCNTL1_ADDR);
    return ((localVal & ((uint32_t)0x00000003)) >> 0);
}

__INLINE void rpl_rpll_vcommon_mode_setf(uint8_t rpllvcomode)
{
    ASSERT_ERR((((uint32_t)rpllvcomode << 0) & ~((uint32_t)0x00000003)) == 0);
...
#define RPL_DPLL_VCOMMON_ON_BIT        ((uint32_t)0x00000004)
#define RPL_DPLL_VCOMMON_ON_POS        2
...
#define RPL_DPLL_VCOMMON_ON_RST        0x0
...
__INLINE uint8_t rpl_dpll_vcommon_on_getf(void)
{
    uint32_t localVal = REG_RPL_RD(RPL_DPLLCNTL0_ADDR);
    return ((localVal & ((uint32_t)0x00000004)) >> 2);
}

__INLINE void rpl_dpll_vcommon_on_setf(uint8_t dpllvcoon)
{
    ASSERT_ERR((((uint32_t)dpllvcoon << 2) & ~((uint32_t)0x00000004)) == 0);
 ...
 *     11         DPLL_VCOMMON_CFG   0
 *  10:08         DPLL_PFD_CFG   0x0
 *  07:04             DPLL_ICP   0x0
 *     03         DPLL_TEST_EN   0
 *     02   DPLL_VCOMMON_SPEEDUP_EN   0
 *     01        DPLL_FRACT_EN   0
 *     00          DPLL_DTP_EN   0
 * </pre>
 */
...
#define RPL_DPLL_VCOMMON_CFG_BIT           ((uint32_t)0x00000800)
#define RPL_DPLL_VCOMMON_CFG_POS           11
...
#define RPL_DPLL_VCOMMON_SPEEDUP_EN_BIT    ((uint32_t)0x00000004)
#define RPL_DPLL_VCOMMON_SPEEDUP_EN_POS    2
...
__INLINE uint8_t rpl_dpll_vcommon_cfg_getf(void)
{
    uint32_t localVal = REG_RPL_RD(RPL_DPLLCNTL2_ADDR);
    return ((localVal & ((uint32_t)0x00000800)) >> 11);
}

__INLINE void rpl_dpll_vcommon_cfg_setf(uint8_t dpllvcocfg)
{
    ASSERT_ERR((((uint32_t)dpllvcocfg << 11) & ~((uint32_t)0x00000800)) == 0);
...
__INLINE uint8_t rpl_dpll_vcommon_speedup_en_getf(void)
{
    uint32_t localVal = REG_RPL_RD(RPL_DPLLCNTL2_ADDR);
    return ((localVal & ((uint32_t)0x00000004)) >> 2);
}

__INLINE void rpl_dpll_vcommon_speedup_en_setf(uint8_t dpllvcospeedupen)
{
    ASSERT_ERR((((uint32_t)dpllvcospeedupen << 2) & ~((uint32_t)0x00000004)) == 0);
...
// field definitions
#define RPL_DPLL_VCOMMON_CLK_OK_BIT     ((uint32_t)0x00000002)
#define RPL_DPLL_VCOMMON_CLK_OK_POS     1
#define RPL_DPLL_LOCK_DETECT_BIT    ((uint32_t)0x00000001)
#define RPL_DPLL_LOCK_DETECT_POS    0

#define RPL_DPLL_VCOMMON_CLK_OK_RST     0x0
...
__INLINE uint8_t rpl_dpll_vcommon_clk_ok_getf(void)
{
    uint32_t localVal = REG_RPL_RD(RPL_DPLLSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000002)) >> 1);
}
...
#define RPL_KVCOMMON_REF_MASK       ((uint32_t)0x000003FF)
#define RPL_KVCOMMON_REF_LSB        0
#define RPL_KVCOMMON_REF_WIDTH      ((uint32_t)0x0000000A)

#define RPL_KVCOSTEP_DEN_RST    0x6
#define RPL_KVCOSTEP_NUM_RST    0x3
#define RPL_ICPCALSIGN_RST      0x0
#define RPL_KVCOMMON_REF_RST        0x1AB
...
__INLINE uint16_t rpl_kvcommon_ref_getf(void)
{
    uint32_t localVal = REG_RPL_RD(RPL_VCOFC_ICP_CALIBCONFIG_ADDR);
    return ((localVal & ((uint32_t)0x000003FF)) >> 0);
}

__INLINE void rpl_kvcommon_ref_setf(uint16_t kvcoref)
{
    ASSERT_ERR((((uint32_t)kvcoref << 0) & ~((uint32_t)0x000003FF)) == 0);
...
#define RPL_LDO_VCOMMON_TRIM_MASK       ((uint32_t)0x00380000)
#define RPL_LDO_VCOMMON_TRIM_LSB        19
#define RPL_LDO_VCOMMON_TRIM_WIDTH      ((uint32_t)0x00000003)
...
#define RPL_LDO_VCOMMON_LP_MODE_BIT     ((uint32_t)0x00000080)
#define RPL_LDO_VCOMMON_LP_MODE_POS     7
...
#define RPL_LDO_VCOMMON_ON_BIT          ((uint32_t)0x00000004)
#define RPL_LDO_VCOMMON_ON_POS          2
...
#define RPL_LDO_VCOMMON_TRIM_RST        0x0
...
#define RPL_LDO_VCOMMON_LP_MODE_RST     0x0
...
#define RPL_LDO_VCOMMON_ON_RST          0x0
...
__INLINE uint8_t rpl_ldo_vcommon_trim_getf(void)
{
    uint32_t localVal = REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR);
    return ((localVal & ((uint32_t)0x00380000)) >> 19);
}

__INLINE void rpl_ldo_vcommon_trim_setf(uint8_t ldovcotrim)
{
    ASSERT_ERR((((uint32_t)ldovcotrim << 19) & ~((uint32_t)0x00380000)) == 0);
...
__INLINE uint8_t rpl_ldo_vcommon_lp_mode_getf(void)
{
    uint32_t localVal = REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR);
    return ((localVal & ((uint32_t)0x00000080)) >> 7);
}

__INLINE void rpl_ldo_vcommon_lp_mode_setf(uint8_t ldovcolpmode)
{
    ASSERT_ERR((((uint32_t)ldovcolpmode << 7) & ~((uint32_t)0x00000080)) == 0);
...
__INLINE uint8_t rpl_ldo_vcommon_on_getf(void)
{
    uint32_t localVal = REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR);
    return ((localVal & ((uint32_t)0x00000004)) >> 2);
}

__INLINE void rpl_ldo_vcommon_on_setf(uint8_t ldovcoon)
{
    ASSERT_ERR((((uint32_t)ldovcoon << 2) & ~((uint32_t)0x00000004)) == 0);
