...
/**
 * @brief GSG_VCOMMON_DEN register definition
 * <pre>
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  04:00          GSG_VCOMMON_DEN   0x6
 * </pre>
 */
#define MDM_GSG_VCOMMON_DEN_ADDR   0x000000C4
#define MDM_GSG_VCOMMON_DEN_OFFSET 0x000000C4
#define MDM_GSG_VCOMMON_DEN_INDEX  0x00000031
#define MDM_GSG_VCOMMON_DEN_RESET  0x00000006

__INLINE uint32_t mdm_gsg_vcommon_den_get(void)
{
    return REG_RPL_RD(MDM_GSG_VCOMMON_DEN_ADDR);
}

__INLINE void mdm_gsg_vcommon_den_set(uint32_t value)
{
    REG_RPL_WR(MDM_GSG_VCOMMON_DEN_ADDR, value);
}

// field definitions
#define MDM_GSG_VCOMMON_DEN_MASK   ((uint32_t)0x0000001F)
#define MDM_GSG_VCOMMON_DEN_LSB    0
#define MDM_GSG_VCOMMON_DEN_WIDTH  ((uint32_t)0x00000005)

#define MDM_GSG_VCOMMON_DEN_RST    0x6

__INLINE uint8_t mdm_gsg_vcommon_den_getf(void)
{
    uint32_t localVal = REG_RPL_RD(MDM_GSG_VCOMMON_DEN_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0x0000001F)) == 0);
    return (localVal >> 0);
}

__INLINE void mdm_gsg_vcommon_den_setf(uint8_t gsgvcoden)
{
    ASSERT_ERR((((uint32_t)gsgvcoden << 0) & ~((uint32_t)0x0000001F)) == 0);
    REG_RPL_WR(MDM_GSG_VCOMMON_DEN_ADDR, (uint32_t)gsgvcoden << 0);
}

/**
 * @brief GSG_VCOMMON_NOM register definition
 * <pre>
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  07:00          GSG_VCOMMON_NOM   0x27
 * </pre>
 */
#define MDM_GSG_VCOMMON_NOM_ADDR   0x000000C5
#define MDM_GSG_VCOMMON_NOM_OFFSET 0x000000C5
#define MDM_GSG_VCOMMON_NOM_INDEX  0x00000031
#define MDM_GSG_VCOMMON_NOM_RESET  0x00000027

__INLINE uint32_t mdm_gsg_vcommon_nom_get(void)
{
    return REG_RPL_RD(MDM_GSG_VCOMMON_NOM_ADDR);
}

__INLINE void mdm_gsg_vcommon_nom_set(uint32_t value)
{
    REG_RPL_WR(MDM_GSG_VCOMMON_NOM_ADDR, value);
}

// field definitions
#define MDM_GSG_VCOMMON_NOM_MASK   ((uint32_t)0x000000FF)
#define MDM_GSG_VCOMMON_NOM_LSB    0
#define MDM_GSG_VCOMMON_NOM_WIDTH  ((uint32_t)0x00000008)

#define MDM_GSG_VCOMMON_NOM_RST    0x27

__INLINE uint8_t mdm_gsg_vcommon_nom_getf(void)
{
    uint32_t localVal = REG_RPL_RD(MDM_GSG_VCOMMON_NOM_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0x000000FF)) == 0);
    return (localVal >> 0);
}

__INLINE void mdm_gsg_vcommon_nom_setf(uint8_t gsgvconom)
{
    ASSERT_ERR((((uint32_t)gsgvconom << 0) & ~((uint32_t)0x000000FF)) == 0);
    REG_RPL_WR(MDM_GSG_VCOMMON_NOM_ADDR, (uint32_t)gsgvconom << 0);
}
