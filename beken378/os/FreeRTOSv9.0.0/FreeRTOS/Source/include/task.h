 ...
 *
 */
void vTaskForceAwake( xTaskHandle xTask ) PRIVILEGED_FUNCTION;
portBASE_TYPE xTaskForceAwakePending(void);
void xTaskForceAwakeClearPending( void );
 ...
 *
 */
xTaskHandle xTaskGetCurrentThread( void ) PRIVILEGED_FUNCTION;
